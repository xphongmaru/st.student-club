    ...
    const _componentCKEditorDocument = function() {
        ...
        DecoupledEditor.create(document.querySelector('#document_editor_empty .document-editor-editable'), {
            ...
            editor.model.document.on('change:data', () => {
                ...
                document.querySelector('#document_editor_empty .document-editor-placeholder').style.display = data ? 'none' : 'block';
            });
            document.querySelector('#document_editor_empty .document-editor-placeholder').style.display = editor.getData() ? 'none' : 'block';
