                        ...
                        <div>
                            @foreach($permissions as $permission)
                                <input wire:model.live="permission_ids" type="checkbox" id="permission_{{$permission->id}}"
                                       name="permissions[]" value="{{$permission->id}}" class="ms-3" @if( $role->name=="Chủ tịch" && ($permission->name == "Quản lý chức vụ" || $permission->name == "Quản lý thành viên")) disabled  @endif >
