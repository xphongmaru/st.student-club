            ...
            <div class="card-body">
                <div class="content-header d-flex justify-content-between align-items-end">
                    ...
                    <div class="content-action d-flex">
                        <a href="{{route('admin.club.category-post.create',['id'=>$club_id])}}" class="btn btn-teal"><i class="ph-plus-circle me-1"></i>Tạo mới</a>
                    </div>
                ...
                <div class="">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 60%">Tên danh mục</th>
                            <th class="text-center" style="width: 30%">Số bài viết</th>
                        ...
                        @else
                            @foreach($categoryPosts as $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{$item->name==null?'< chưa có tiêu đề >':$item->name}}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{ route('admin.club.category-post.detail', ['id' => $club_id, 'category_id'=> $item->id])}}" class="dropdown-item">
                                                    <i class="ph-eye me-2"></i>
                                                    Xem chi tiết
                                                </a>
                                                <a href="{{ route('admin.club.category-post.edit', ['id' => $club_id, 'category_id'=> $item->id])}}" class="dropdown-item text-warning">
                                                    <i class="ph-pencil me-2"></i>
                                                    Chỉnh sửa
                                                </a>
                                                <button type="button" wire:click="openDeleteModel({{ $item->id }})" class="dropdown-item text-danger">
