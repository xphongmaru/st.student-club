        ...
        <div class="page-header-content d-lg-flex border-top">
            <div class="d-flex">
                <div class="breadcrumb py-2">
                    ...
                    <span class="breadcrumb-item active"> Chỉnh sửa thông báo </span>
                </div>
            </div>
...
@section('page-content')
    <div class="content">
        <!-- Content -->
        <livewire:admin.clubs.notifications.edit :club_id="$club_id" :notification_id="$notification_id"/>
        <!-- /Content -->
    </div>
@endsection
    ...
    <script>
        $(document).ready(function() {
            $('.multiselect').on('change', function () {
                ...
                Livewire.dispatch('updateMultiselect', selected);
            });
        });
    </script>
@endsection
